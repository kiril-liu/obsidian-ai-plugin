# Magic Wand AI Assistant

Magic Wand AI Assistant 是一个面向 Obsidian 的 AI 助手插件，支持 Chat 对话、Vault 检索、RAG 语义问答、Prompt Library、Daily Note 工作流、批量 Prompt、历史对话和 AI 回答插入。
当前稳定版本：`1.8.0`
...
- In Chat, you can type: `/Daily Review`
